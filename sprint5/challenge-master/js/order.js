...
function savePost(event) {
    ...
    alert(formProps.orderId+" "+formProps.custname+" "+formProps.email +" "+formProps.contact+" "+formProps.orderDate+" "+formProps.adress+" "+formProps.address
    +" "+formProps.categoryname+" "+" "+formProps.itemnname+" "+" "+formProps.price+" "+" "+formProps.quantity+" "+" "+formProps.amt+" ");
